...
*-# 2017-06-30(2.13.20)
*-# a.增加@link #dvpSetConfigString 设置相机字符串参数@endlink的接口
*-# 2017-07-17(2.14.21)
...
*-# a.增加了加载@link #dvpLoadUserSet 用户设置@endlink的功能
*/
...
*@param[in] handle 相机句柄
*@param[in] value 名称
*@param[out] pConfigString 字符串参数
*@return 状态码
*@ingroup __DVP2_API_INTERNAL__
*@see dvpSetConfigString
*/
dvp2api dvpStatus dvpGetConfigString(dvpHandle handle, dvpStr value, dvpStr *pConfigString);
...
*@param[in] handle 相机句柄
*@param[in] value 名称
*@param[in] ConfigString 字符串参数
*@return 状态码
*@ingroup __DVP2_API_INTERNAL__
*@see dvpGetConfigString
*/
dvp2api dvpStatus dvpSetConfigString(dvpHandle handle, dvpStr value, dvpStr ConfigString);
...
*/
dvp2api dvpStatus dvpReadUserData(dvpHandle handle, dvpUint32 addr, const void *pBuffer, dvpUint32 size);
